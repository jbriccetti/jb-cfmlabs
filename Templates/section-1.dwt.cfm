			...
			<div class="row-fluid">
				<nav class="span3">
					<ul class="nav nav-tabs nav-stacked">
						<li><a href="../tests/dw-templates/section-1/index.cfm">Section 1 Home</a></li>
						<li><a href="../tests/dw-templates/section-1/page1.cfm">Section 1 Page 1</a></li>
						<li><a href="../tests/dw-templates/section-1/page2.cfm">Section 1 Page 2</a></li>
					</ul>
				</nav>
				<div class="span9">
					<h2>Section 1</h2>
