	...
	<div class="container-fluid">
		<!-- InstanceBeginEditable name="content" -->
			<div class="row-fluid">
				<nav class="span3">
					<ol>
						<li><a href="../tests/dw-templates/section-2/index.cfm">Section 2 Home</a></li>
						<li><a href="../tests/dw-templates/section-2/page1.cfm">Section 2 Page 1</a></li>
						<li><a href="../tests/dw-templates/section-2/page2.cfm">Section 2 Page 2</a></li>
					</ol>
				</nav>
				<div class="span9">
					<h2>Section 2</h2>
