<!DOCTYPE html>
<html class="no-js"><!-- InstanceBegin template="/Templates/tier-main.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
	<meta charset="utf-8">
	...
	<!-- InstanceParam name="section" type="text" value="" passthrough="true" -->
	<!-- InstanceParam name="sectionURL" type="URL" value="" passthrough="true" -->
</head>
<body>
	...
	<script type="text/javascript" charset="utf-8">
		$(document).ready(function () {
			...
			console.log('call a url like: /api.cfc?method=getnav&section=@@(section)@@&format=html');
