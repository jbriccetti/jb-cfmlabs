<!DOCTYPE html>
<html class="no-js"><!-- InstanceBegin template="/Templates/section-1.dwt.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
	<meta charset="utf-8">
			...
			<div class="row-fluid">
				<nav class="span3">
					<ul class="nav nav-tabs nav-stacked">
						<li><a href="index.cfm">Section 1 Home</a></li>
						<li><a href="page1.cfm">Section 1 Page 1</a></li>
						<li><a href="page2.cfm">Section 1 Page 2</a></li>
					</ul>
				</nav>
				<div class="span9">
					<h2>Section 1</h2>
