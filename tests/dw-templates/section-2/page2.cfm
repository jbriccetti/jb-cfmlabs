<!DOCTYPE html>
<html class="no-js"><!-- InstanceBegin template="/Templates/section-2.dwt.cfm" codeOutsideHTMLIsLocked="false" -->
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div class="container-fluid">
			...
			<div class="row-fluid">
				<nav class="span3">
					<ol>
						<li><a href="index.cfm">Section 2 Home</a></li>
						<li><a href="page1.cfm">Section 2 Page 1</a></li>
						<li><a href="page2.cfm">Section 2 Page 2</a></li>
					</ol>
				</nav>
				<div class="span9">
					<h2>Section 2</h2>
